...
use NFePHP\NFSe\Models\Tecnos\Factories;


class Tools extends ToolsBase
{
    protected $xmlns = 'http://www.Tecnos.org.br/nfse.xsd';
    ...
    {
        $class = "NFePHP\\NFSe\\Models\\Tecnos\\Factories\\v{$this->versao}\\GerarNfse";
        $fact = new $class($this->certificate);
